 ...
 */
const _withPlugins = ([...plugins], nextConfig = {}) => {return (phase, {
  defaultConfig
}) => {
...
const extend = baseConfig => {return {
  withPlugins: (...params) => {return (phase, nextOptions) => {
